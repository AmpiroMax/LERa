...
https://github.com/allenai/allenact/blob/main/allenact/embodiedai/models/visual_nav_models.py
"""
...
from fiqa.navigation.allenact.allenact.algorithms.onpolicy_sync.policy import (
    ActorCriticModel,
    LinearCriticHead,
    LinearActorHead,
    ObservationType,
...
from fiqa.navigation.allenact.allenact.base_abstractions.distributions import \
    CategoricalDistr
from fiqa.navigation.allenact.allenact.base_abstractions.misc import \
    ActorCriticOutput, Memory
from fiqa.navigation.allenact.allenact.embodiedai.aux_losses.losses import \
    MultiAuxTaskNegEntropyLoss
from fiqa.navigation.allenact.allenact.embodiedai.models.aux_models import \
    AuxiliaryModel
from fiqa.navigation.allenact.allenact.embodiedai.models.basic_models import \
    RNNStateEncoder
from fiqa.navigation.allenact.allenact.embodiedai.models.fusion_models import \
    Fusion
from fiqa.navigation.allenact.allenact.utils.model_utils import \
    FeatureEmbedding
from fiqa.navigation.allenact.allenact.utils.system import get_logger
