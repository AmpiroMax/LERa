...
https://github.com/allenai/allenact/blob/main/projects/objectnav_baselines/experiments/clip/mixins.py
and slightly modified. 
We've added the ability to allow running without normalization.
"""
...
from fiqa.navigation.allenact.allenact.embodiedai.sensors.vision_sensors \
    import RGBSensor, DepthSensor
from fiqa.navigation.allenact.allenact.utils.experiment_utils import Builder
...
from fiqa.navigation.allenact.allenact_plugins.navigation_plugin.objectnav.models \
    import ResnetTensorNavActorCritic
        ...
        if depth_sensor is not None:
            preprocessors.append(
                ClipResNetPreprocessor(
                    ...
                    input_img_height_width=(
                        depth_sensor.height, depth_sensor.width),
                )
            )
