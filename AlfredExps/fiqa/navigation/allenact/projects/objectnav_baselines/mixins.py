...
https://github.com/allenai/allenact/blob/main/projects/objectnav_baselines/mixins.py 

In order to remove dependence on ai2thor.fifo_server, we replaced 
`len(ObjectNavTask.class_action_names())` on line 134 with 
fixed number of actions --- 6 in ALFRED.
"""
...
from fiqa.navigation.allenact.allenact.base_abstractions.preprocessor import \
    Preprocessor
...
#     CPCA16SoftMaxLoss,
# )
from fiqa.navigation.allenact.allenact.embodiedai.preprocessors.resnet import \
    ResNetPreprocessor
from \
    fiqa.navigation.allenact.allenact.embodiedai.sensors.vision_sensors import \
        RGBSensor, DepthSensor
from fiqa.navigation.allenact.allenact.utils.experiment_utils import (
    Builder,
    # TrainingPipeline,
    # PipelineStage,
    # LinearDecay,
...
from fiqa.navigation.allenact.allenact_plugins.navigation_plugin.objectnav.models \
    import (
        ResnetTensorNavActorCritic,
        # ObjectNavActorCritic,
    )
# from fiqa.navigation.allenact.allenact_plugins.robothor_plugin.robothor_tasks \
#     import ObjectNavTask
