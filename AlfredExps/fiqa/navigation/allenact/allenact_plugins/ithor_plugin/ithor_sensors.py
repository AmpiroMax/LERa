...
https://github.com/allenai/allenact/blob/main/allenact_plugins/ithor_plugin/ithor_sensors.py

We've deleted any use of `RoboThorEnvironment` 
since it uses `aithor.fifo_server` (which is not present in ai2thor==2.1.0)
"""
# import copy
...
from fiqa.navigation.allenact.allenact.base_abstractions.task import Task
# from allenact.embodiedai.mapping.mapping_utils.map_builders import (
#     BinnedPointCloudMapBuilder,
#     SemanticMapBuilder,
#     ObjectHull2d,
# )
from fiqa.navigation.allenact.allenact.embodiedai.sensors.vision_sensors \
    import RGBSensor
from fiqa.navigation.allenact.allenact.utils.misc_utils import \
    prepare_locals_for_super
from fiqa.navigation.allenact.allenact_plugins.ithor_plugin.ithor_environment \
    import IThorEnvironment
from fiqa.navigation.allenact.allenact_plugins.ithor_plugin.ithor_tasks \
    import ObjectNaviThorGridTask
# from allenact_plugins.ithor_plugin.ithor_util import include_object_data
# from fiqa.navigation.allenact.allenact_plugins.robothor_plugin.robothor_environment \
#     import RoboThorEnvironment
...
THOR_ENV_TYPE = Union[
    ...
    ai2thor.controller.Controller, IThorEnvironment
]
