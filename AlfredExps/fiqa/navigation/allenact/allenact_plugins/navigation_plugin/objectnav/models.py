...
https://github.com/allenai/allenact/blob/main/allenact_plugins/navigation_plugin/objectnav/models.py
...
from fiqa.navigation.allenact.allenact.algorithms.onpolicy_sync.policy import \
    ObservationType
from fiqa.navigation.allenact.allenact.embodiedai.models import \
    resnet as resnet
# from allenact.embodiedai.models.basic_models import SimpleCNN
from fiqa.navigation.allenact.allenact.embodiedai.models.visual_nav_models \
    import (
