...
# https://github.com/askforalfred/alfred/blob/master/data/preprocess.py
...
from alfred_utils.gen.utils.py_util import remove_spaces_and_lower
from alfred_utils.gen.utils.game_util \
    import sample_templated_task_desc_from_traj_data
