...
https://github.com/askforalfred/alfred/blob/master/env/tasks.py
"""
import json
import numpy as np
from alfred_utils.gen.graph import graph_obj
from alfred_utils.gen.utils.game_util import get_objects_with_name_and_prop
from alfred_utils.env.reward import get_action
